...
```{r simplot, echo=FALSE, out.width='40%', fig.width=7, fig.height=7.5}
set.seed(2312)
...
plot(
  ...
  main = "Random dots within the unit circle",
  pch  = 19
  )
```
...
And voilá! A temporary bash file will be generated and used submit the R script
to the queue.
